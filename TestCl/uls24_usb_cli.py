#!/usr/bin/env python3
"""
Alternative CLI interface for ULS24 device using PyUSB
For systems where hidraw kernel module is not available
"""
import argparse
import sys
import time
from uls24_usb import ULS24DeviceUSB

def main():
    """Main function handling command line arguments"""
    parser = argparse.ArgumentParser(description='ULS24 Device Control Script (PyUSB Version)')
    ...
    device = ULS24DeviceUSB(debug=args.debug)
